...
\label{cha:model_identification}
    ...
    \section{Mathematical Model Creation}
        ...
        \subsection{DC Motor}
            ...
            this is the output of the DC Motor's Model.

        \subsection{Flexible Joint and The Gearbox}

            Considering in the same section the joint and the mechanical components of the motor, it is possible to write down the two equation of the 2 mechanical system considering:
            \[
                \]
