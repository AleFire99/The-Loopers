function [Kp,Ti] = PI_Ziegler_Nichols(sysest_ct, zeta, wn)

G_sysest_ct = tf(sysest_ct);
G_theta_cont = G_sysest_ct(1);
G_alpha_cont = G_sysest_ct(1);
eigs = pole(G_sysest_ct(1));
