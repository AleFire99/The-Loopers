...
% A_tilde = [ sysest_ct_tip.A, -sysest_ct_tip.B*K_lqr_eta , sysest_ct_tip.B*K_lqr_x;
%             -[1 0 1 0], -[0]*K_lqr_eta , -[0]*K_lqr_x;
%             L_obs*sysest_ct.C, -sysest_ct_tip.B*K_lqr_eta, sysest_ct_tip.A-sysest_ct_tip.B*K_lqr_x];
% B_tilde = [ zeros(4,1);
%             eye(1,1);
%             zeros(4,1)];       
