...
typedef RT_MODEL_Validation_Template__T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Validation_Template_2019a(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Validation_Template_2019a_initialize();
   extern void Validation_Template_2019a_terminate();
 */
...
static void rtExtModeSingleTaskUpload(RT_MODEL * S)
{
  {                                    /* Sample time: [0.0s, 0.0s] */
    rtExtModeUpload(0, Validation_Template_2019a_M->Timing.t[0]);
  }

  {                                    /* Sample time: [0.002s, 0.0s] */
    rtExtModeUpload(1, (((Validation_Template_2019a_M->Timing.clockTick1+
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Validation_Template_2019a_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  Validation_Template_2019a_step();
  ...
  control_c_handler(int signal_number)
{
  ...
  GBLbuf.stopExecutionFlag = 1;
  rtExtModeStart();
  hil_task_stop(Validation_Template_2019a_DW.Encoders_Task)
    ;
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Validation_Template_2019a:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Validation_Template_2019a -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Validation_Template_2019a_initialize();
  S = Validation_Template_2019a_M;
  ...
  if (rtExtModeQuarcStartup(rtmGetRTWExtModeInfo(S),
    ...
    if (rtmGetErrorStatus(S) == NULL) {
      ...
      fflush(stdout);
      result = hil_task_start(Validation_Template_2019a_DW.Encoders_Task,
        (t_clock) Validation_Template_2019a_P.Encoders_clock, 500.0, -1)
        ;
      if (result == 0) {
  ...
  Validation_Template_2019a_terminate();
