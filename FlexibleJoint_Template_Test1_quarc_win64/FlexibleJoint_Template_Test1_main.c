...
typedef RT_MODEL_FlexibleJoint_Templa_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * FlexibleJoint_Template_Test1(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void FlexibleJoint_Template_Test1_initialize();
   extern void FlexibleJoint_Template_Test1_terminate();
 */
...
static void rtExtModeSingleTaskUpload(RT_MODEL * S)
{
  {                                    /* Sample time: [0.002s, 0.0s] */
    rtExtModeUpload(0, FlexibleJoint_Template_Test1_M->Timing.taskTime0);
  }
}
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(FlexibleJoint_Template_Test1_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  FlexibleJoint_Template_Test1_step();
  ...
  control_c_handler(int signal_number)
{
  ...
  GBLbuf.stopExecutionFlag = 1;
  rtExtModeStart();
  hil_task_stop(FlexibleJoint_Template_Test1_DW.Encoders_Task)
    ;
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://FlexibleJoint_Template_Test1:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: FlexibleJoint_Template_Test1 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  FlexibleJoint_Template_Test1_initialize();
  S = FlexibleJoint_Template_Test1_M;
  ...
  if (rtExtModeQuarcStartup(rtmGetRTWExtModeInfo(S),
    ...
    if (rtmGetErrorStatus(S) == NULL) {
      ...
      fflush(stdout);
      result = hil_task_start(FlexibleJoint_Template_Test1_DW.Encoders_Task,
        (t_clock) FlexibleJoint_Template_Test1_P.Encoders_clock, 500.0, -1)
        ;
      if (result == 0) {
  ...
  FlexibleJoint_Template_Test1_terminate();
